...
# GUIA DE SIMULADOR
    ...
    def _accion_fallo(self):
        ...
        # Contenedor para las dos columnas (Izquierda: Tipo, Derecha: Servidor)
        frame_opciones = tk.Frame(modal.cuerpo, bg=COLOR_FONDO)
        frame_opciones.pack(fill="both", expand=True, pady=5)

        # --- COLUMNA IZQUIERDA: TIPOS DE FALLO ---
        f_izq = tk.Frame(frame_opciones, bg=COLOR_FONDO)
        f_izq.pack(side="left", fill="both", expand=True, padx=10)
        
        tk.Label(f_izq, text="Tipo de Fallo:", font=FUENTE_SUBTIT, bg=COLOR_FONDO, fg=COLOR_ROJO).pack(anchor="w", pady=(0, 10))
        ...
        # --- COLUMNA DERECHA: SELECCIÓN DE SERVIDOR ---
        f_der = tk.Frame(frame_opciones, bg=COLOR_FONDO)
        f_der.pack(side="right", fill="both", expand=True, padx=10)
        
        tk.Label(f_der, text="Dispositivo:", font=FUENTE_SUBTIT, bg=COLOR_FONDO, fg=COLOR_ROJO).pack(anchor="w", pady=(0, 10))
        ...
        # Servidores dinámicos activos en el sistema
        ...
        BotonJuego(modal.cuerpo, "RETROCEDER", self._destruir_modal_previo, color_acento=COLOR_TEXTO_SUAVE).pack(pady=5)
